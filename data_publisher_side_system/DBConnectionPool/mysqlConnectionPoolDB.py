...
class Mysql(object):
    ...
    def __init__(self):
        if not Mysql.__pool:
            ...
            '''
            #Mysql.__pool = PooledDB(creator=MySQLdb, mincached=1, maxcached=10000, host=MySQL_config.db_host, port=MySQL_config.db_port, user=MySQL_config.db_user, passwd=MySQL_config.db_user_passwd, db=MySQL_config.db_name, use_unicode=False, charset=MySQL_config.db_charset)
