...
def get_average_speed():
    ...
    while not query_sql_flag:
        try:
            ...
            continue
    ingestion_date_list = []
    for ingestion_date, _ in query_results:
        ingestion_date_list.append(ingestion_date)

    ingestion_date_list.sort()

    sum_size = 201600*row_count/1024.0/1024
    print('sum_size:%f (GB)'%(201600*200000/1024.0/1024/1024))
    elapsed_time = ingestion_date_list[-1] - ingestion_date_list[4]
